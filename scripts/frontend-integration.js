 ...
 * This file demonstrates how to integrate Embervault with a web frontend
 */

// For React/Vue/Angular applications
export class EmbervaultClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new EmbervaultClient(provider, contractAddress);
